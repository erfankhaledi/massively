    ...
    return (
        <div class="pagination">
            ...
            <a href="#" className="next">
                Next
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="10" fill="currentColor" className="bi bi-chevron-right" viewBox="0 0 16 16" style={{ marginLeft: "10px", fontSize: '50px' }}>
